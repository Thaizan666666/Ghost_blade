...
namespace Ghost_blade
{
    ...
    {
        public MapLab02(Texture2D bg, Texture2D layer2, AnimatedTexture DoorOpenTexture,
                  ...
                  new Vector2(95 * 48, 95 * 48), new Rectangle(0, 0, 3285 * 2, 2970 * 2)) //
        {
            ...
            AddObstacle(43, 16, 17, 2);
            AddObstacle(90, 82, 2, 0.5f);
            AddObstacle(39, 16, 5, 1);
            ...
            AddEnemy(new EnemyLaser(enemyTexture1, enemyTexture, ChargingLaser, DeathLaser, enemyTexture, new Vector2(106 * tileSize, 64 * tileSize), 1.0f, 1000f, Laser));
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(115 * tileSize, 52 * tileSize), 1.5f, 1000f));
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(107 * tileSize, 43 * tileSize), 1.5f, 1000f));
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(91 * tileSize, 63 * tileSize), 1.5f, 1000f));
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(53 * tileSize, 58 * tileSize), 1.5f, 1000f));
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(34 * tileSize, 58 * tileSize), 1.5f, 1000f));
            AddEnemy(new Enemy_Shooting(EnemyShooting_Idle, EnemyShooting_Walk, EnemyShooting_Death, enemyTexture, new Vector2(34 * tileSize, 70 * tileSize), 1.0f, 1000f, bulletTexture, parry));
            AddEnemy(new Enemy_Shooting(EnemyShooting_Idle, EnemyShooting_Walk, EnemyShooting_Death, enemyTexture, new Vector2(53 * tileSize, 70 * tileSize), 1.0f, 1000f, bulletTexture, parry));
            AddEnemy(new EnemyLaser(enemyTexture1, enemyTexture, ChargingLaser, DeathLaser, enemyTexture, new Vector2(43 * tileSize, 64 * tileSize), 1.0f, 1000f, Laser));
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(42 * tileSize, 30 * tileSize), 1.5f, 1000f));
            AddEnemy(new EnemyLaser(enemyTexture1, enemyTexture, ChargingLaser, DeathLaser, enemyTexture, new Vector2(42 * tileSize, 22 * tileSize), 1.0f, 1000f, Laser));
            AddEnemy(new Enemy_Shooting(EnemyShooting_Idle, EnemyShooting_Walk, EnemyShooting_Death, enemyTexture, new Vector2(55 * tileSize, 26 * tileSize), 1.0f, 1000f, bulletTexture, parry));
            AddEnemy(new Enemy_Shooting(EnemyShooting_Idle, EnemyShooting_Walk, EnemyShooting_Death, enemyTexture, new Vector2(30 * tileSize, 26 * tileSize), 1.0f, 1000f, bulletTexture, parry));
        }
    }
}