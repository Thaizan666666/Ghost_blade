...
namespace Ghost_blade
{
    public class MapLab03 : Room
    {
                  ...
                  new Vector2(23 * 48, 96 * 48), new Rectangle(0, 0, 3285 * 2, 2970 * 2)) //
        {
            ...
            AddEnemy(new Enemy_Shooting(EnemyShooting_Idle, EnemyShooting_Walk, enemyTexture, new Vector2(37 * tileSize, 70 * tileSize), 1.0f, 1000f, bulletTexture));
            AddEnemy(new Enemy_Shooting(EnemyShooting_Idle, EnemyShooting_Walk, enemyTexture, new Vector2(33 * tileSize, 54 * tileSize), 1.0f, 1000f, bulletTexture));
            AddEnemy(new Enemy_Shooting(EnemyShooting_Idle, EnemyShooting_Walk, enemyTexture, new Vector2(85 * tileSize, 48 * tileSize), 1.0f, 1000f, bulletTexture));
        }
    }
}