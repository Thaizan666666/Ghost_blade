...
namespace Ghost_blade
{
    public class MapLab03 : Room
    {
        ...
        public MapLab03(Texture2D bg, Texture2D layer2, AnimatedTexture DoorOpenTexture,
            ...
            : base(bg, layer2, DoorOpenTexture, new Rectangle(89 * 48, 39 * 48, 4 * 48, 1 * 48), new Vector2(89 * 48, 38 * 48),
                  new Vector2(23 * 48, 96 * 48), new Rectangle(0, 0, 3285 * 2, 2970 * 2)) //
        {
            ...
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(15 * tileSize, 70 * tileSize), 1.5f, 1000f));
            AddEnemy(new Enemy_Melee(Enemymelee_Idle, Enemymelee_Walk, Enemymelee_Attack, Enemymelee_Death, enemyTexture, new Vector2(16 * tileSize, 30 * tileSize), 1.5f, 1000f));
